...
## Content
  ...
  * [Security & environment variables](docs/guides/security.md) (sandboxing, CSRF, token handling)
...
| [**Reference**](docs/guides/reference.md) | CLI, 36+ commands, 33 built-in tools (incl. WebBrowse, ReadEmail, SendEmail, ReadPDF, ReadSpreadsheet), session search, auxiliary model, error classification, prompt injection detection, tool cache, parallel tools |
...
| [**Security & env vars**](docs/guides/security.md) | Threat model, every `CHEETAHCLAWS_*` env var, bot-token handling, Bash denylist, file-system sandbox, plugin / MCP / web hardening, CSRF, terminal session owner-binding |
